...
| スルーホールタップ（短）<br>M2 1.0mm | 〓 | 予備1個含む。[マックエイト THC-〓](〓) |
| スルーホールタップ（長）<br>M2 2.0mm | 〓 | 予備1個含む。[マックエイト THC-〓](〓) |
...
1. `スルーホールタップ（短）`を取り付ける。（左右それぞれ3個、計6個）
...
1. `スルーホールタップ（短）`を取り付ける。（左右それぞれ2個、計4個）
...
1. `ボトムプレート`2枚と`ボトムカバー`1枚を重ね、`樹脂ネジ（5mm）`でとめる。（左右それぞれ〓箇所、計〓箇所）
    〓ボトムカバーにはネジ穴がたくさん開いているが、ネジを取り付けない箇所がある。（全部やらなくてもいけるやろ？）
...
**☠️危険：ボトムプレートを重ねる際、基板Baseの部品に当てないように注意する。**
**強く当てると、部品が取れたり、基板が壊れたりします。**
