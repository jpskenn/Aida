...
| スペーサー<br>中空 M2 3.5mm | 6 | [ヒロスギ 〓](〓) |
| スルーホールタップ（短）<br>TH-0.8-1.0-M2 | 6〓合ってる？ | [マックエイト TH-0.8-1.0-M2](https://www.mac8sdk.co.jp/products/458) |
| スルーホールタップ（長）<br>TH-0.8-2.0-M2 | 〓 | [マックエイト TH-0.8-2.0-M2](https://www.mac8sdk.co.jp/products/458) |
| スルーホールタップ（短）ネジなし<br>THC-0.8-1.0-2 | 〓 | [マックエイト THC-0.8-1.0-2](https://www.mac8sdk.co.jp/products/713) |
...
1. `基板Mid内側`を`基板Base`の上に重ね、`金属ネジ（3mm）`でとめる。（左右それぞれ〓箇所、計〓箇所）
...
1. `Mid内側用スイッチプレート`を`基板Mid内側`の上に重ね、`金属ネジ（5mm）`でとめる。（左右それぞれ〓箇所、計〓箇所）
...
1. `基板Top`を`スペーサー`を挟んで`基板Mid内側`の上に重ね、`金属ネジ（8mm）`でとめる。（左右それぞれ1箇所、計2箇所）
...
1. `Top用スイッチプレート`を`基板Top`に重ね、さらに、それらを`スペーサー`を挟んで`基板Mid内側`の上に重ね、`金属ネジ（10mm）`でとめる。（左右それぞれ2箇所、計4箇所）
...
1. 全体を裏返し、`基板Base`のうら側（部品がたくさん取り付けてある側）が見えるように置く。

1. `ボトムプレート`2枚と`ボトムカバー`1枚を`基板Base`に重ね、`樹脂ネジ（5mm）`でとめる。（左右それぞれ〓箇所、計〓箇所）
